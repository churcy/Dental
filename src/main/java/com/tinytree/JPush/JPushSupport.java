...
public class JPushSupport {
	...
	private static final JPushBean JPUSHBEAN = (JPushBean) LoadProperty2Bean.getInstance().getBean(LoadProperty2Bean.JPUSH);
	private static JPushClient jpushClient = new JPushClient(JPUSHBEAN.getMasterSecret(),JPUSHBEAN.getAppKey());
